(() => {
  ...
  style.textContent=`
    ...
    @media(max-width:700px){.shadow.medium{width:28px!important;height:28px!important}.shadow.large,.shadow.gold{width:44px!important;height:44px!important}.catch{padding:20px;gap:10px}.catch-recover{min-width:140px;padding:12px 24px}.detail-size{font-size:10px}.size-records{font-size:8px}.catch-rarity{font-size:18px}}
