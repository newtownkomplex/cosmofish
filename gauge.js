(() => {
  ...
  style.textContent=`
    ...
    .catch{grid-template-rows:auto auto auto auto auto!important;gap:12px;padding:30px;text-align:center}.catch-label{font-size:clamp(16px,3vw,28px);letter-spacing:.18em;color:#f7f5d9}.catch-label.new-species{color:#fff500}.catch-label.analysis-complete{color:#72d9ff}.catch-label.new-record{color:#c084ff}.catch-label.fry{color:#ff8fc7}.catch-success{font-size:clamp(18px,3vw,30px);letter-spacing:.08em}.catch-fish-name{font-size:clamp(22px,4vw,38px);letter-spacing:.06em;color:#fff500!important}.catch-fish-name.common-catch{color:#fff500!important}.catch-rarity{display:block;font-size:clamp(18px,3vw,26px);line-height:1.2;letter-spacing:.12em;margin:0 0 4px;vertical-align:baseline}.catch-rarity.common{color:#ff4b4b}.catch-rarity.rare{color:#72d9ff}.catch-rarity.mythical{color:#c084ff}.catch-rarity.unconfirmed{color:#f7f5d9}.catch-size{font-size:clamp(14px,2.5vw,24px);color:#f7f5d9;letter-spacing:.08em}.catch-recover{min-width:180px;padding:14px 32px;border:2px solid #fff500;background:#fff500;color:#19383b;font:inherit;cursor:pointer;letter-spacing:.08em}
    ...
    @media(max-width:700px){.spot{width:min(25%,110px)!important}.spot:nth-child(1){top:2%!important}.spot:nth-child(2),.spot:nth-child(3){top:37%!important}.spot:nth-child(4),.spot:nth-child(5),.spot:nth-child(6){top:72%!important}.shadow.medium{width:28px!important;height:28px!important}.shadow.large,.shadow.gold{width:44px!important;height:44px!important}.catch{padding:20px;gap:10px}.catch-recover{min-width:140px;padding:12px 24px}.detail-size{font-size:10px}.size-records{font-size:8px}.catch-rarity{font-size:18px}}
